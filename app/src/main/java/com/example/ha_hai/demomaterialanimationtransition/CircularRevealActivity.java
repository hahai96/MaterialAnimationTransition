...
import com.example.ha_hai.demomaterialanimationtransition.databinding.ActivityCircularRevealBinding;
import com.example.ha_hai.demomaterialanimationtransition.model.Sample;

public class CircularRevealActivity extends HelperActivity implements View.OnTouchListener {
    ...
    private void bindData() {
        ActivityCircularRevealBinding binding = DataBindingUtil.setContentView(this, R.layout.activity_circular_reveal);
        mSample = (Sample) getIntent().getExtras().getSerializable(EXTRA_SAMPLE);
        binding.setReveal1Sample(mSample);
    }
    ...
    private void setupLayout() {
        ...
        toolbar = findViewById(R.id.toolbarTransitions);
        ...
        shared_target = findViewById(R.id.shared_target);
        shared_target.setColorFilter(ContextCompat.getColor(this, mSample.getColor()), android.graphics.PorterDuff.Mode.SRC_IN);
    }
    ...
    private void revealRed() {
        ...
        transition.addListener(new Transition.TransitionListener() {
            ...
            public void onTransitionEnd(Transition transition) {
                ...
                body.setTextColor(ContextCompat.getColor(CircularRevealActivity.this, R.color.theme_red_background));
    ...
    // viewRoot is the view we want to animate
    // centerX and centerY are the starting points of the animation, relative to a view.
    // startRadius and endRadius are the radius of the animated circle.
